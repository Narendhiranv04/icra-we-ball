...
CANONICAL_ROBOT_CAPABILITIES: dict[str, tuple[RobotCapability, ...]] = {
    "kitchen": (
        RobotCapability(
            ...
            allowed_target_roles=("prepared_cup_target", "coffee_container", "beverage_cup"),
        ...
        RobotCapability(
            ...
            allowed_target_roles=("soup_bowl_target", "soup_container", "soup_bowl"),
            allowed_anchor_roles=(),
            required_relation_templates=(
                ("source", "INSERTABLE_IN", "target"),
                ("source", "REACHES_BOTTOM", "target"),
